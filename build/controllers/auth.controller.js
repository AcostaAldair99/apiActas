...
exports.signIn = exports.isSignin = void 0;
...
var signIn = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
    var _yield$pool$query, _yield$pool$query2, result, token;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _context.next = 3;
          return _database.pool.query("SELECT user FROM users WHERE pass=? AND user=?", [req.body.pass, req.body.user]);
        case 3:
...
var isSignin = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(req, res) {
    var _yield$pool$query3, _yield$pool$query4, data;
  ...
  return function isSignin(_x3, _x4) {
