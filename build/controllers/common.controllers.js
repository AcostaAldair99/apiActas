...
exports.updateCeremony = exports.updateCaseFolder = exports.gotAsignActas = exports.getTelephones = exports.getTelephone = exports.getFolders = exports.getEstante = exports.getEmails = exports.getEmail = exports.getCountActasFolder = exports.getCeremonies = exports.deleteTelephones = exports.deleteFolder = exports.deleteEmails = exports.deleteCeremony = exports.createCeremony = exports.addTelephone = exports.addFolder = exports.addEmail = exports.addActaToFolder = void 0;
...
var getEstante = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(req, res) {
    var idFolder, _yield$pool$query3, _yield$pool$query4, respon;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          ...
          _context2.prev = 1;
          _context2.next = 4;
          return _database.pool.query("SELECT `id_case` FROM `folder` WHERE `id_folder`=?", [idFolder]);
        case 4:
  ...
  return function getEstante(_x3, _x4) {
    return _ref2.apply(this, arguments);
  };
}();
exports.getEstante = getEstante;
var updateCaseFolder = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(req, res) {
    var _req$params, idFolder, idCase, _yield$pool$query5, _yield$pool$query6, respon;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          _req$params = req.params, idFolder = _req$params.idFolder, idCase = _req$params.idCase;
          _context3.prev = 1;
          _context3.next = 4;
          return _database.pool.query("UPDATE `folder` SET `id_case` = ? WHERE `id_folder` = ?", [idCase, idFolder]);
        case 4:
          _yield$pool$query5 = _context3.sent;
          _yield$pool$query6 = _slicedToArray(_yield$pool$query5, 1);
          respon = _yield$pool$query6[0];
          if (!(respon.affectedRows === 0)) {
            _context3.next = 9;
            break;
          }
  ...
  return function updateCaseFolder(_x5, _x6) {
...
var addActaToFolder = /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(req, res) {
    var id_folder, _yield$pool$query7, _yield$pool$query8, response;
  ...
  return function addActaToFolder(_x7, _x8) {
    return _ref4.apply(this, arguments);
  };
}();
exports.addActaToFolder = addActaToFolder;
var getCountActasFolder = /*#__PURE__*/function () {
  var _ref5 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(req, res) {
    var idFolder, _yield$pool$query9, _yield$pool$query10, response;
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        case 0:
          ...
          _context5.prev = 1;
          _context5.next = 4;
          return _database.pool.query("SELECT COUNT(*) FROM actas WHERE id_Folder_fk=?", [idFolder]);
        case 4:
          _yield$pool$query9 = _context5.sent;
          _yield$pool$query10 = _slicedToArray(_yield$pool$query9, 1);
          response = _yield$pool$query10[0];
  ...
  return function getCountActasFolder(_x9, _x10) {
    return _ref5.apply(this, arguments);
  };
}();
exports.getCountActasFolder = getCountActasFolder;
var addFolder = /*#__PURE__*/function () {
  ...
  return function addFolder(_x11, _x12) {
...
var deleteFolder = /*#__PURE__*/function () {
  var _ref7 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee7(req, res) {
    var id_folder, _yield$pool$query11, _yield$pool$query12, respon;
  ...
  return function deleteFolder(_x13, _x14) {
...
var getCeremonies = /*#__PURE__*/function () {
  ...
  return function getCeremonies(_x15, _x16) {
...
var createCeremony = /*#__PURE__*/function () {
  ...
  return function createCeremony(_x17, _x18) {
...
var updateCeremony = /*#__PURE__*/function () {
  var _ref10 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee10(req, res) {
    var id_ceremony, data, _yield$pool$query15, _yield$pool$query16, respon;
  ...
  return function updateCeremony(_x19, _x20) {
    return _ref10.apply(this, arguments);
  };
}();
exports.updateCeremony = updateCeremony;
var gotAsignActas = /*#__PURE__*/function () {
  var _ref11 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee11(req, res) {
    var idCeremony, _yield$pool$query17, _yield$pool$query18, respon;
    return _regeneratorRuntime().wrap(function _callee11$(_context11) {
      while (1) switch (_context11.prev = _context11.next) {
        case 0:
          idCeremony = req.params.idCeremony;
          _context11.prev = 1;
          _context11.next = 4;
          return _database.pool.query("SELECT COUNT(*) FROM actas WHERE id_ceremony_fk = ? AND signatures = 3", [idCeremony]);
        case 4:
          _yield$pool$query17 = _context11.sent;
          _yield$pool$query18 = _slicedToArray(_yield$pool$query17, 1);
          respon = _yield$pool$query18[0];
          if (!(respon.affectedRows === 0)) {
            _context11.next = 9;
            break;
          }
  ...
  return function gotAsignActas(_x21, _x22) {
    return _ref11.apply(this, arguments);
  };
}();
exports.gotAsignActas = gotAsignActas;
var deleteCeremony = /*#__PURE__*/function () {
  var _ref12 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee12(req, res) {
    var idCeremony, _yield$pool$query19, _yield$pool$query20, respon;
    return _regeneratorRuntime().wrap(function _callee12$(_context12) {
      while (1) switch (_context12.prev = _context12.next) {
        case 0:
          ...
          _context12.prev = 1;
          _context12.next = 4;
          return _database.pool.query("DELETE FROM `ceremony` WHERE `id_ceremony`=?", [idCeremony]);
        case 4:
          _yield$pool$query19 = _context12.sent;
          _yield$pool$query20 = _slicedToArray(_yield$pool$query19, 1);
          respon = _yield$pool$query20[0];
          if (!(respon.affectedRows === 0)) {
            _context12.next = 9;
            break;
          }
  ...
  return function deleteCeremony(_x23, _x24) {
    return _ref12.apply(this, arguments);
  };
}();
exports.deleteCeremony = deleteCeremony;
var addTelephone = /*#__PURE__*/function () {
  ...
  return function addTelephone(_x25, _x26) {
...
var getTelephones = /*#__PURE__*/function () {
  var _ref14 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee14(req, res) {
    ...
    return _regeneratorRuntime().wrap(function _callee14$(_context14) {
      while (1) switch (_context14.prev = _context14.next) {
        ...
        case 3:
          _yield$pool$query21 = _context14.sent;
  ...
  return function getTelephones(_x27, _x28) {
...
var getTelephone = /*#__PURE__*/function () {
  var _ref15 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee15(req, res) {
    var id, _yield$pool$query23, _yield$pool$query24, respon;
    return _regeneratorRuntime().wrap(function _callee15$(_context15) {
      while (1) switch (_context15.prev = _context15.next) {
        ...
        case 4:
          _yield$pool$query23 = _context15.sent;
          _yield$pool$query24 = _slicedToArray(_yield$pool$query23, 1);
          respon = _yield$pool$query24[0];
  ...
  return function getTelephone(_x29, _x30) {
...
var deleteTelephones = /*#__PURE__*/function () {
  ...
  return function deleteTelephones(_x31, _x32) {
...
var addEmail = /*#__PURE__*/function () {
  var _ref17 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee17(req, res) {
    var sql, data, _yield$pool$query25, _yield$pool$query26, review;
    return _regeneratorRuntime().wrap(function _callee17$(_context17) {
      while (1) switch (_context17.prev = _context17.next) {
        ...
        case 5:
          _yield$pool$query25 = _context17.sent;
          _yield$pool$query26 = _slicedToArray(_yield$pool$query25, 1);
          review = _yield$pool$query26[0];
          if (review.affectedRows === 0) res.status(404).json({
            message: "id sinoidal not found"
          });
          res.status(201).json({
  ...
  return function addEmail(_x33, _x34) {
...
var getEmail = /*#__PURE__*/function () {
  var _ref18 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee18(req, res) {
    var id, _yield$pool$query27, _yield$pool$query28, data;
    return _regeneratorRuntime().wrap(function _callee18$(_context18) {
      while (1) switch (_context18.prev = _context18.next) {
        ...
        case 4:
          _yield$pool$query27 = _context18.sent;
          _yield$pool$query28 = _slicedToArray(_yield$pool$query27, 1);
          data = _yield$pool$query28[0];
  ...
  return function getEmail(_x35, _x36) {
...
var getEmails = /*#__PURE__*/function () {
  var _ref19 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee19(req, res) {
    var _yield$pool$query29, _yield$pool$query30, respon;
    return _regeneratorRuntime().wrap(function _callee19$(_context19) {
      while (1) switch (_context19.prev = _context19.next) {
        ...
        case 3:
          _yield$pool$query29 = _context19.sent;
          _yield$pool$query30 = _slicedToArray(_yield$pool$query29, 1);
          respon = _yield$pool$query30[0];
          res.json(respon);
          _context19.next = 12;
          break;
        case 9:
  ...
  return function getEmails(_x37, _x38) {
...
var deleteEmails = /*#__PURE__*/function () {
  var _ref20 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee20(req, res) {
    var sql, data, _yield$pool$query31, _yield$pool$query32, get;
    return _regeneratorRuntime().wrap(function _callee20$(_context20) {
      while (1) switch (_context20.prev = _context20.next) {
        case 0:
          ...
          return _database.pool.query(sql, [data.idSinoidal]);
        case 5:
          _yield$pool$query31 = _context20.sent;
          _yield$pool$query32 = _slicedToArray(_yield$pool$query31, 1);
          get = _yield$pool$query32[0];
          if (get.affectedRows === 0) res.status(404).json({
            message: "Sinoidal not found"
          });
          res.status(201).json({
  ...
  return function deleteEmails(_x39, _x40) {
